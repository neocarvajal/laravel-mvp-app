...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'ruc_number'=>'required|string|unique:providers,ruc_number,'. $this->route('provider')->id.'|max:11', 
            'address'=>'nullable|string|max:255',
            'phone'=>'required|string|unique:providers,phone,'. $this->route('provider')->id.'|min:11|', 
        ];
    }
